...
namespace MedicalSchedulingBackend.Presentation.Exceptions;
...
internal sealed class GlobalExceptionHandler : IExceptionHandler
{
                                          ...
                                          CancellationToken cancellationToken)
    {
        ...
        var problemDetails = exception switch
        {
            ...
            UnauthorizedException un => CreateProblemDetails("Unauthorized", un.Message, 401, "https://tools.ietf.org/html/rfc9110#section-15.5.2", httpContext, activity),
